 ...
 */
public class YoupinhuiActivity extends BaseActivity implements PullToRefreshBase.OnRefreshListener2, AdapterView.OnItemClickListener {
    //listview的page
    private int mPage = 1;
    private HomeYoupinhuiAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_youpinhui);
        initView();
    }

    private void initView() {
        backBtn = (Button) findViewById(R.id.youpinhui_back);
        ...
        mPullToRefreshListView = (PullToRefreshListView) findViewById(R.id.home_youpinhui_listview);
        mListView = mPullToRefreshListView.getRefreshableView();
        mPullToRefreshListView.setMode(PullToRefreshBase.Mode.BOTH);
        mAdapter = new HomeYoupinhuiAdapter(this,null);
