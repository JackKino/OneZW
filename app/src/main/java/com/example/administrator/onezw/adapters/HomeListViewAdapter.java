...
public class HomeListViewAdapter extends BaseAdapter {
    ...
    public HomeListViewAdapter(Context context,List<HomeListViewModel.DetailEntity> data){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            holder.name = (TextView) convertView.findViewById(R.id.home_listview_name);
            holder.promoPrice = (TextView) convertView.findViewById(R.id.home_listview_promo_price);
            holder.originPrice = (TextView) convertView.findViewById(R.id.home_listview_origin_price);
            holder.discount = (TextView) convertView.findViewById(R.id.home_listview_discount);
            holder.sales = (TextView) convertView.findViewById(R.id.home_listview_sales);
            holder.img = (ImageView) convertView.findViewById(R.id.home_listview_img);
