 ...
 */
public class HomeNextAdapter extends BaseAdapter {
    private List<HomeListViewModel.DetailEntity> data;
    private LayoutInflater inflater;
    public HomeNextAdapter(Context context, List<HomeListViewModel.DetailEntity> data){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView = inflater.inflate(R.layout.item_home_gridview_next,parent,false);
            holder = new ViewHolder();
            holder.name = (TextView) convertView.findViewById(R.id.home_next_name);
            holder.promoPrice = (TextView) convertView.findViewById(R.id.home_next_promo_price);
            holder.sales = (TextView) convertView.findViewById(R.id.home_next_sales);
            holder.img = (ImageView) convertView.findViewById(R.id.home_next_img);
