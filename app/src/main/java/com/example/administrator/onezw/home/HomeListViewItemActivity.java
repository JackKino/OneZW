 ...
 */
public class HomeListViewItemActivity extends BaseActivity{
    private WebView mWebView;
    private boolean isExit;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_home_listview_item);
        initView();
    }

    private void initView() {
        mWebView = (WebView) findViewById(R.id.home_listview_item_webview);
