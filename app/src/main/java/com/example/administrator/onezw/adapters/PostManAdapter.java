...
public class PostManAdapter extends BaseAdapter {
    ...
    public PostManAdapter(Context context, List<HomeListViewModel.DetailEntity> data){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView = inflater.inflate(R.layout.item_postman_gridview,parent,false);
            holder = new ViewHolder();
            holder.name = (TextView) convertView.findViewById(R.id.postman_name);
            holder.promoPrice = (TextView) convertView.findViewById(R.id.postman_promo_price);
            holder.sales = (TextView) convertView.findViewById(R.id.postman_sales);
            holder.img = (ImageView) convertView.findViewById(R.id.postman_img);
